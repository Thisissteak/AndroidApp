...
//        initData();
        MusicitemAdapter itemAdapter = new MusicitemAdapter(this,R.layout.activity_musicitem,musicList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(MainActivity.this,"您选择了"+ musicList.get(i).getName(),Toast.LENGTH_SHORT).show();
//                Intent intent = new Intent(MusicListActivity.this,.class);
